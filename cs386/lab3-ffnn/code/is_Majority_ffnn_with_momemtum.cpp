...
long int ffnn(vector < vector <double> > & pattern, vector<Layer> & l,vector<double> & output, double eta, double threshold, double momentumFactor)
{	
