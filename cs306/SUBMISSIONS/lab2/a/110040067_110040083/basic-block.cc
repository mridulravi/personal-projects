...
// one dobt here, that we are returning the end result only, whereas result will be calculated for each member of the statement list, so we should return a list of the results, instead of a single result
