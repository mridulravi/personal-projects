...
class Program
{
	...
	map<string, bool> defined_procedure;
	map<string, int> called_procedure;
...
public:
	...
	// define a function get_procedure(string proc_name), which will return Proc*, 
	Procedure * get_procedure(string proc_name);
	void set_procedure_defined(string proc_name);
	bool get_procedure_defined(string proc_name);
	void set_called_procedure(string proc_name);
	bool get_called_procedure(string proc_name);
	map<string, int> get_called_procedure_list();
