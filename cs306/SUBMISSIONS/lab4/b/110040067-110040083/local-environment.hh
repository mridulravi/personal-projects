...
public:
	...
	// added by me
	virtual void set_functional(bool temp);
	virtual bool get_functional();

	// added by me
	virtual void set_execution_status(bool a);
	virtual bool get_execution_status();
...
public:
	...
	// added by me
	void set_functional(bool temp);
	bool get_functional();

	void set_execution_status(bool temp);
