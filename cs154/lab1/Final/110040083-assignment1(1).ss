...
(x-of (curve t))
(y-of (curve t))))
0 1 #:width 1 #:samples 50000
#:x-min -35.0 #:x-max 35.0
#:y-min -10.0 #:y-max 60.0)))
;
;
;
;
...
(define (kochify curve)
  (let ((line1 curve)
        (line2 ((translate 1 0)
                ((rotate-around-origin (/ pi 3)) curve)))
        (line3 ((translate 1.5 (/ (sqrt 3) 2)) 
                ((rotate-around-origin (- (/ pi 3))) curve)))
        (line4 ((translate 2 0) curve)))       
       ((scale (/ 1 3) (/ 1 3))
        (connect-rigidly
        (connect-rigidly line1 line2)
        (connect-rigidly line3 line4)))))
...
(define square-box
  (let ((line1 ((rotate-around-origin (/ pi 4)) 
                unit-line))
        (line2 ((translate (/ 1 (sqrt 2)) (/ 1 (sqrt 2)))
                ((rotate-around-origin (* (/ pi 4) 3)) 
                unit-line)))
        (line3 ((translate 0 (sqrt 2))
                ((rotate-around-origin (* (/ pi 4) 5)) 
                unit-line)))
        (line4 ((translate (-(/ 1 (sqrt 2))) (/ 1 (sqrt 2)))
                ((rotate-around-origin (* (/ pi 4) 7)) 
                unit-line)))) 
    (connect-rigidly
     (connect-rigidly
      (connect-rigidly line1 line2) line3) line4)))
...
(define (cactasize factor)
   (lambda (curve)
     ...
     (let* (
            (right-block ((translate (/ scale-factor (sqrt 2)) 
                                     (/ scale-factor (sqrt 2))) 
                          ((rotate-around-origin (-(/ pi 2))) 
                          curve)))
            (upper-block ((translate 0 (* scale-factor (sqrt 2))) 
                          curve))
            (left-block ((translate (-(/ scale-factor (sqrt 2))) 
                                    (/ scale-factor (sqrt 2))) 
                          ((rotate-around-origin (+ (/ pi 2))) 
                          curve)))
            (line1 ((scale scale-factor scale-factor) 
                    ((rotate-around-origin (/ pi 4)) 
                     unit-line)))
            (line2 ((translate (/ scale-factor (sqrt 2)) 
                               (/ scale-factor (sqrt 2)))
                    ((scale scale-factor scale-factor) 
                    ((rotate-around-origin (* (/ pi 4) 3)) 
                     unit-line))))
            (line3 ((translate 0 (* scale-factor (sqrt 2))) 
                    ((scale scale-factor scale-factor) 
                    ((rotate-around-origin (* (/ pi 4) 5)) 
                     unit-line)))) 
            (line4 ((translate (- (/ scale-factor (sqrt 2))) 
                               (/ scale-factor (sqrt 2)))
                    ((scale scale-factor scale-factor) 
                    ((rotate-around-origin (* (/ pi 4) 7)) 
                     unit-line)))))
       (connect-rigidly
        (connect-rigidly
         (connect-rigidly
          (connect-rigidly
           (connect-rigidly
            (connect-rigidly line1 right-block)
            line2)
           upper-block)
          line3)
         left-block)
...
(define (cactus n)
   ((scale (/ 1 ( expt (+ n 1) 3)) (/ 1 ( expt (+ n 1) 3))) 
